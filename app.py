...
def genera_word_report(dati):
    ...
    r_logo.font.color.rgb = RGBColor(0, 0, 0) # Nero corporativo
    ...
    # Linea divisoria elegante sotto l'intestazione
...
if file_cad_caricato is not None:
    ...
    # Import locale o gestione ezdxf
    import ezdxf
